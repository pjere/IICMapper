...
public class Mapper {
	 ...
	 * @param args
	 */
	public static void KMLMaker(String S3ICbFileName, String S3ICFileName, String GEREPFileName, String KMLName)
	{
		...
		try
		{
			...
			{
				Site CurrentSite = new Site( rdr.readLine() , S3ICFileName, GEREPFileName);
				...
				PlaceMark = PlaceMark + "<Placemark><name>"+CurrentSite.getS3ICNum()+"</name><styleUrl>#My_Style</styleUrl><Point><coordinates>";
	...
	public static void main(String[] args) {
		...
		KMLMaker("/home/pjere/JavaProjects/IICMapper/src/XLSFiles/Extraction S3IC-b.csv", "/home/pjere/JavaProjects/IICMapper/src/XLSFiles/Extraction S3IC.csv", "/home/pjere/JavaProjects/IICMapper/src/XLSFiles/GEREP air.csv", "/home/pjere/JavaProjects/IICMapper/src/XLSFiles/testKML.kml");
